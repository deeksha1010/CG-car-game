...
class CarRacing:
    def __init__(self):
        ...
        self.clock = pygame.time.Clock() #clock function added
    ...
    def run_car(self):
        ...
        while not self.crashed:
            ...
            self.run_enemy_car(self.enemy_car_startx, self.enemy_car_starty) #taking enemy carx and Y coordinates
            self.enemy_car_starty += self.enemy_car_speed #increment of enemy car speed
